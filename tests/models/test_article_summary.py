...
def test_article_summary_creation(article_summary_factory):
    # An ArticleSummary should be created successfully
    # with valid ranked article and summary data.
    article_summary = article_summary_factory(
        ...
        quality_score=0.80,
        summary=(
            "Researchers developed an AI model that "
    ...
    assert article_summary.key_takeaway == (
        "AI significantly improves diagnostic perfomance."
    )
